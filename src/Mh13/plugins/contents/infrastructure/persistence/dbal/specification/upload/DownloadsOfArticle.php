...
class DownloadsOfArticle extends CompositeDbalSpecification
{
    ...
    {
        return "article.slug = :slug AND upload.type NOT LIKE 'image%' AND upload.type NOT LIKE 'video%'AND upload.type NOT LIKE 'audio%'";
    }
}
