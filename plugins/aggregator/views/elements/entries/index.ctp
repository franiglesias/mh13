...
?>
<section id="mh-aggregator-last-entries" class="media">
	...
	<?php foreach ($entries as $entry): ?>
		...
		<article class="<?php echo $class; ?>"> 
			...
			<footer class="media-footer entry-footer">
				<p><?php echo $this->Article->time($entry['Entry']['pubDate']); ?><?php __(' in '); ?> <?php echo $this->Html->link($entry['Feed']['title'], $feedUrl, array('class' => 'mh-button mh-feed-link')); ?></p>
			</footer>
		</article>
	<?php endforeach ?>
	</div>
