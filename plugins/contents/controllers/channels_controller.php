...
class ChannelsController extends ContentsAppController {
	...
	var $name = 'Channels';
	var $helpers = array('Uploads.Upload', 'Access.Owner', 'Contents.Channel', 'Contents.Channels');
	var $components = array('Security', 'Filters.SimpleFilters', 'Ui.Ui');
 ...
 */
 	function view($slug = null, $tag = null, $level_id = null) 
	{
 ...
 */	
 	function tagged ($slug = null, $tag = null) {
 ...
 */	
 	function level ($slug = null, $level_id = null) {
 ...
 */
	...
	public function external()
	{
		...
		return $this->Channel->findExternal();
	}
