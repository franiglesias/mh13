...
class ItemsController extends ContentsAppController {
	...
	var $helpers = array('Uploads.Upload', 'Access.Owner', 'Contents.Post', 'Comments.Comment', 'Contents.Items', 'Contents.Item', 'Contents.Channel', 'Contents.Authors', 'Contents.Author', 'Ui.Images', 'Ui.Image');
	
	var $components = array('Security', 'Filters.SimpleFilters', 'Notify', 'Contents.Feed');
	//var $layout = 'backend';
 ...
 * @return void
 */	
	function author_edit($id = null) {
		$this->layout = 'backend';
		$this->role = 'author';
		$this->setAction('edit', $id);
	}

	function contributor_edit($id = null) {
		$this->layout = 'backend';
