<div class="content" id="tabs-2">
	<fieldset>
		<legend><?php __d('circulars', 'Field trip details'); ?></legend>
		...
		<div class="row">
			<?php
				echo $this->FForm->date('Event.startDate', array(
					...
					'error' => array(
						'notEmpty' => sprintf(__d('circulars', 'Provide a date for this %s', true), __d('circulars', 'field trip', true))
					),
					'clearable' => true,
		...
		<div class="row">
			<?php echo $this->Multilingual->element('circulars/fieldtrip/event', array('plugin' => 'circulars')); ?>
		</div>
