<?php
	...
	$tableCode = $this->Table->render($deviceTypes, $options);
?> 
<section id="deviceTypes-index" class="mh-admin-panel">
	<header>
		<h1><?php printf(__('Admin %s', true), __d('it', 'Device Types', true));?>
