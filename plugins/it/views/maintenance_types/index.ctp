<?php
	...
	$tableCode = $this->Table->render($maintenanceTypes, $options);
?> 
<section id="maintenanceTypes-index" class="mh-admin-panel">
	<header>
		<h1><?php printf(__('Admin %s', true), __d('it', 'Maintenance Types', true));?>
