...
$options = array(
	...
	'actions' => array(
		...
		'delete' => array('label' => __('Delete', true), 'confirm' => __('Are you sure?', true))
		),
	'table' => array('class' => 'admin-table')
	);
	
	$tableCode = $this->Table->render($roles, $options);
?>
<section id="roles-index" class="mh-admin-panel">
	<header>
		<h1><?php printf(__('Admin %s', true), __d('access', 'Roles', true));?>
	...
	<div class="row">
		<div class="small-12 medium-3 columns">
			...
			<div class="mh-admin-widget">
				...
				echo $this->SimpleFilter->contains('Role.role', array('label' => __d('access', 'Role', true)));
