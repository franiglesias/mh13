...
$theme['Theme']['sizes']['itemMainImage'] 		= array('width' => 640, 'height' => 128, 'method' => 'fill');
...
$theme['Theme']['sizes']['channelMainImage'] 	= array('width' => 960, 'height' => 288, 'method' => 'fill');
...
$theme['Theme']['sizes']['directLinksIcon']		= array('width' => 48, 'height' => 48, 'method' => 'fill');
$theme['Theme']['sizes']['itemListImage-1'] 	= array('width' => 130, 'height' => 130, 'method' => 'fit');
$theme['Theme']['sizes']['itemListImage-2'] 	= array('width' => 270, 'height' => 270, 'method' => 'fit');
$theme['Theme']['sizes']['itemListImage-3'] 	= array('width' => 410, 'height' => 410, 'method' => 'fit');
$theme['Theme']['sizes']['itemListImage-4'] 	= array('width' => 550, 'height' => 550, 'method' => 'fit');

$theme['Theme']['sizes']['smallListImage']	= array('width' => 402, 'height' => 134, 'method' => 'fill');
$theme['Theme']['sizes']['mediumListImage']	= array('width' => 210, 'height' => 210, 'method' => 'fill');
$theme['Theme']['sizes']['largeListImage']	= array('width' => 250, 'height' => 250, 'method' => 'fill');

$theme['Theme']['sizes']['ListImage']['small']	= array('width' => 402, 'height' => 134, 'method' => 'fill');
$theme['Theme']['sizes']['ListImage']['medium']	= array('width' => 210, 'height' => 210, 'method' => 'fill');
$theme['Theme']['sizes']['ListImage']['large']	= array('width' => 250, 'height' => 250, 'method' => 'fill');


$theme['Theme']['sizes']['AltListImage']['small']	= array('width' => 402, 'height' => 134, 'method' => 'fill');
$theme['Theme']['sizes']['AltListImage']['medium']	= array('width' => 134, 'height' => 134, 'method' => 'fill');
$theme['Theme']['sizes']['AltListImage']['large']	= array('width' => 201, 'height' => 201, 'method' => 'fill');


$theme['Theme']['sizes']['mainPageImage']['small']	= array('width' => 414, 'height' => 310, 'method' => 'fill');
$theme['Theme']['sizes']['mainPageImage']['medium']	= array('width' => 1024, 'height' => 205, 'method' => 'fill');
$theme['Theme']['sizes']['mainPageImage']['large']	= array('width' => 2048, 'height' => 409, 'method' => 'fill');


$theme['Theme']['sizes']['mainLogo']['small']	= array('width' => 125, 'height' => 125, 'method' => 'fit');
$theme['Theme']['sizes']['mainLogo']['medium']	= array('width' => 200, 'height' => 200, 'method' => 'fit');
$theme['Theme']['sizes']['mainLogo']['large']	= array('width' => 250, 'height' => 250, 'method' => 'fit');
