...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' + 
                '<div class="qq-upload-drop-area small-3 columns"><span>{dragText}</span></div>' +
                '<div class="qq-upload-button small-3 columns">{uploadButtonText}</div>' +
                '<div class="small-6 columns"><ul class="qq-upload-list"></ul></div>' + 
             '</div>',
