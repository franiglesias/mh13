<?php
	...
	$tableCode = $this->Table->render($circularBoxes, $options);
?> 
<section id="circular-boxes-index" class="mh-admin-panel">
	<header>
		<h1><?php printf(__('Admin %s', true), __d('circulars', 'Circular Boxes', true));?>
