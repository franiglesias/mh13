<div class="content" id="tabs-2">
	<fieldset>
		<legend><?php __d('circulars', 'Internal Activity details'); ?></legend>
		...
		<div class="row">
			<?php
				echo $this->FForm->date('Event.startDate', array(
					...
					'error' => array(
						'notEmpty' => sprintf(__d('circulars', 'Provide a date for this %s', true), __d('circulars', 'internal activity', true))
					),
					'clearable' => true,
		...
		<div class="row">
			<?php echo $this->Multilingual->element('circulars/internal/event', array('plugin' => 'circulars')); ?>
		</div>
