...
qq.obj2url = function (obj, temp, prefixDone) {
    var uristrings = [],
        ...
        if (nextTemp != 'undefined' && i != 'undefined') {
            uristrings.push((typeof nextObj === 'undefined' ? 'undefined' : _typeof(nextObj)) === 'object' ? qq.obj2url(nextObj, nextTemp, true) : Object.prototype.toString.call(nextObj) === '[object Function]' ? encodeURIComponent(nextTemp) + '=' + encodeURIComponent(nextObj()) : encodeURIComponent(nextTemp) + '=' + encodeURIComponent(nextObj));
        }
    };
    ...
    } else if (typeof obj != 'undefined' && obj !== null && (typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) === "object") {
...
qq.FileUploaderBasic = function (o) {
    this._options = {
        ...
        onUpload: function onUpload(id, fileName, xhr) {},
        onError: function onError(id, fileName, xhr) {},
        // messages                
        messages: {
...
qq.FileUploaderBasic.prototype = {
    ...
    _onUpload: function _onUpload(id, fileName, xhr) {},
...
qq.FileUploader = function (o) {
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' + '<div class="qq-upload-drop-area small-3 columns"><span>{dragText}</span></div>' + '<div class="qq-upload-button small-3 columns">{uploadButtonText}</div>' + '<div class="small-6 columns"><ul class="qq-upload-list"></ul></div>' + '</div>',

        // template for one item in file list
        fileTemplate: '<li>' + '<span class="qq-progress-bar"></span>' + '<span class="qq-upload-file"></span>' + '<span class="qq-upload-spinner"></span>' + '<span class="qq-upload-size"></span>' + '<a class="qq-upload-cancel" href="#">{cancelButtonText}</a>' + '<span class="qq-upload-failed-text">{failUploadtext}</span>' + '</li>',
...
qq.extend(qq.FileUploader.prototype, {
    ...
    _setupExtraDropzone: function _setupExtraDropzone(element) {
        this._options.extraDropzones.push(element);
        this._setupDropzone(element);
    },
    _setupDropzone: function _setupDropzone(dropArea) {
        var self = this;
...
qq.UploadDropZone.prototype = {
    _dragover_should_be_canceled: function _dragover_should_be_canceled() {
